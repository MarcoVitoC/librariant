<footer class="bg-cornsilk mt-5 px-4">
   <div class="d-flex align-items-center justify-content-between mx-6 pt-3 pb-4">
      <div>
         ...
         <div class="d-flex">
            <i class="bi bi-telephone-fill me-2"></i></i><p>+6281-123-456-789</p>
         </div>
         <div class="d-flex">
            <i class="bi bi-envelope-fill me-2"></i></i><p>librariant.edu@gmail.com</p>
         </div>
      </div>
      <div>
      ...
      <div class="w-25">
         <img src="{{ asset('images/Librariant Logo (Light).png') }}" alt="Librariant" width="160px" height="50px">
