...
@section('content')
   ...
   <div class="m-6">
      <div class="row align-items-center mx-4 p-3 rounded">
         <div class="col-md-5 how-it-works-background">
   ...
   <div class="m-6">
      ...
      <div class="d-flex justify-content-between mx-4">
         @foreach ($books as $book)
            <a href="{{ route('guest.book_details', $book->id) }}" class="card text-decoration-none" style="width: 15rem;">
   ...
   <div class="m-6">
      <div class="row align-items-center mx-4 rounded">
         ...
         <div class="col-md-6 get-started-background">
