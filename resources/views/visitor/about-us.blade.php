...
@section('content')
   ...
   <div class="m-6">
      ...
      <div class="row px-4">
         <div class="col-md-4 text-left" data-aos="fade-right" data-aos-delay="100" data-aos-duration="1000">
        ...
        <div class="col-md-4 text-left" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
            <div class="d-flex flex-column h-100 bg-body-tertiary rounded p-3">
        ...
        <div class="col-md-4 text-left" data-aos="fade-left" data-aos-delay="300" data-aos-duration="1000">
            <div class="d-flex flex-column h-100 bg-body-tertiary rounded p-3">
   ...
   <div class="m-6">
      <div class="row align-items-center mx-4 rounded">
         ...
         <div class="col-md-6" data-aos="fade-left" data-aos-duration="1000">
            ...
            <h6 class="mt-5 mb-3 bg-body-tertiary rounded p-2 w-75">⌚ Monday - Saturday, from 9:00 a.m. to 6:00 p.m.</h6>
            <h6 class="my-3 bg-body-tertiary rounded p-2 w-75">📍 Education Street No.10A</h6>
            <h6 class="my-3 bg-body-tertiary rounded p-2 w-75">☎️ +62 811-2345-6789</h6>
            <h6 class="my-3 bg-body-tertiary rounded p-2 w-75">📧 librariant.edu@gmail.com</h6>
         </div>
      </div>
   </div>
